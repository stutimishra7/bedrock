...
WORKDIR /usr/src/chatbotKnowledgeBasedFrontend

# Copy dependency definitions
COPY package.json /usr/src/chatbotKnowledgeBasedFrontend
COPY package-lock.json /usr/src/chatbotKnowledgeBasedFrontend
...
COPY . /usr/src/chatbotKnowledgeBasedFrontend
